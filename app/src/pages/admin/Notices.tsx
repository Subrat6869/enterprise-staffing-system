...
import { Bell, Plus, Search, Trash2, Edit2, AlertCircle } from 'lucide-react';
import DashboardLayout from '@/components/layout/DashboardLayout';
import { getAllNotices, deleteNotice, createNotice, updateNotice } from '@/services/firestoreService';
...
const AdminNotices: React.FC = () => {
  ...
  const openModal = (notice?: Notice) => {
    if (notice) {
      ...
      setFormData({ title: notice.title, message: notice.message, category: notice.category });
    } else {
